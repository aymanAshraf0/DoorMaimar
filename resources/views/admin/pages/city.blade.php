...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">المدن</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ المدن</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
...
@can('اضافه مدينه')
<a href="#" class="card-title mg-b-0 btn btn-warning" data-toggle="modal" data-target="#modaldemo1">اضافه مدينه</a>                     
@endcan
<div>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table text-md-nowrap" id="example">
                                                            ...
                                                            <tbody>
                                                                    ...
                                                                    <td>
                                                                        @can('تعديل مدينه')
                                                                        <a   href="{{url('/editCity',$item->id)}}" class="btn btn-primary">تعديل</a>
                                                                        @endcan
                                                                        @can('حذف مدينه')
                                                                        <a href="{{ url('deleteCity', ['id' => $item->id]) }}" class="btn btn-danger delete-button">حذف</a>
                                                                        @endcan
                                                                    </td>
                                                                    </tr>
                                                                    @endforeach
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content modal-content-demo">
					...
					<div class="modal-header">
						<h6 class="modal-title">اضافه مدينه</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
					</div>
					<div class="modal-body">
                    <form action="{{url('/add_city')}}" method="post">
                    @csrf
                    <input class="form-control m-1" type="text" name="city_name" placeholder="اسم المدينه">
