...
<form action="{{url('/updateRealEstate')}}" method="post" enctype="multipart/form-data">
    @csrf
<input type="hidden" name="id" value="{{$data->id}}">
	...
	<div class="row g-3 align-items-center m-3">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="numberOfOffer" id="numberOfOffer" value="{{$data->number_of_offer}}" placeholder="رقم العرض">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
	...
	<div class="row g-3 align-items-center m-3">
		...
		<div class="col-10">
		  <input type="number" class="form-control" name="price" id="price" value="{{$data->price}}" placeholder="السعر">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="kindOfPrice" id="kindOfPrice" value="{{$data->kindOfPrice}}" placeholder="نوع السعر">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="fieldDelegate" id="fieldDelegate" value="{{$data->fieldDelegate}}" placeholder="المندوب الميداني">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="date" class="form-control" name="date" id="date" value="{{$data->date}}" placeholder="التاريخ">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		  <label for="images"  style="font-size: larger;" class="col-form-label  text-center">الصوره </label>
		</div>
		<div class="col-10">
		  <input type="file" class="form-control" name="images" id="images">
		  <img src="{{asset("uploads/images/realEstateImage/$data->images")}}" width="100">
		</div>
	  </div>
	  ...
	  <div class="row g-3 align-items-center m-3">
		...
		<div class="col-10" >
			<select style="width: 100% !important;" class="form-select form-select-lg" name="realEstate" id="realEstate">
				<option value="{{$data->Real_estate_id}}">{{$data->Real_estate->real_estate_name}}</option>
	  ...
	  <div class="row g-3 align-items-center m-3">
		...
		<div class="col-10" >
			<select style="width: 100% !important;" class="form-select form-select-lg" name="city" id="city">
				<option value="{{$data->city_id}}">{{$data->cities->city_name}}</option>
	...
	<div class="row g-3 align-items-center m-3">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="neighborhood" id="neighborhood" value="{{$data->neighborhood}}" placeholder="الحي السكني">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="floors" id="floors"  value="{{$data->floors}}" placeholder="الادوار">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="numberOfRooms" id="numberOfRooms"  value="{{$data->numberOfRooms}}" placeholder="عدد الغرف">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="numberOfEntrances" id="numberOfEntrances"  value="{{$data->numberOfEntrances}}" placeholder="عدد المداخل">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="elevators" id="elevators" value="{{$data->elevators}}" placeholder="المصاعد">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="bathrooms" id="bathrooms" value="{{$data->bathrooms}}" placeholder="الحمامات">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="numberOfLivingrooms" id="numberOfLivingrooms" value="{{$data->numberOfLivingrooms}}" placeholder="عدد الصالات">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="kindOfStairs" id="kindOfStairs" value="{{$data->kindOfStairs}}" placeholder="نوع الدرج">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="theYard" id="theYard" value="{{$data->theYard}}" placeholder="الحوش">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="interFace" id="interFace" value="{{$data->interFace}}" placeholder="الواجهه">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="widthOfStreet" id="widthOfStreet" value="{{$data->widthOfStreet}}" placeholder="عرض الشارع">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="ageOfRealEstate" id="ageOfRealEstate" value="{{$data->ageOfRealEstate}}" placeholder="عمر العقار">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="barking" id="barking" value="{{$data->barking}}" placeholder="الباركينج">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="Maid_s_room" id="Maid_s_room" value="{{$data->Maid_s_room}}" placeholder="عرفه الخادمه">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="security_room" id="security_room" value="{{$data->security_room}}" placeholder="غرفه الحارس">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="Driver_s_room" id="Driver_s_room" value="{{$data->Driver_s_room}}" placeholder="غرفه السائق">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="space" id="space" value="{{$data->space}}" placeholder="المساحه">
		</div>
	  </div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="Swimming_pools" id="Swimming_pools" value="{{$data->Swimming_pools}}" placeholder="المسابح">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="piece_number" id="piece_number" value="{{$data->piece_number}}" placeholder="رقم القطعه">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="the_owner_s_name" id="the_owner_s_name" value="{{$data->the_owner_s_name}}" placeholder="اسم المالك">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="owner_s_phone_number" id="owner_s_phone_number" value="{{$data->owner_s_phone_number}}" placeholder="رقم هاتف المالك">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="security_name" id="security_name" value="{{$data->security_name}}" placeholder="اسم الحارس">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="security_number" id="security_number" value="{{$data->security_number}}" placeholder="رقم هاتف الحارس">
		</div>
	  </div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
		  <input type="text" class="form-control" name="coordinates" id="coordinates" value="{{$data->coordinates}}" placeholder="الاحداثيات">
		</div>
	  </div>
	  <div class="row g-3 align-items-center m-3">
		<div class="col-2">
	...
	<div class="row g-3 align-items-center m-3">
		...
		<div class="col-10">
		  <input type="date" class="form-control" name="date2" id="date2" value="{{$data->date2}}" placeholder="التاريخ">
		</div>
	</div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
			<textarea class="form-control" name="notes" id="notes" value="{{$data->notes}}" placeholder="الملاحظات"></textarea>
		</div>
	</div>
	<div class="row g-3 align-items-center m-3">
		<div class="col-2">
		...
		<div class="col-10">
			<textarea class="form-control" name="Special_note" id="Special_note" value="{{$data->Special_note}}" placeholder="ملاحظه خاصه"></textarea>
		</div>
	</div>
	
    <div class="text-center">
    <button type="submit" class="btn btn-warning text-dark  m-1">تعديل</button>
	</div>
    </form>
