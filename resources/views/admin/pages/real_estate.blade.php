...
@can('اضافه نوع عقار')
<a href="#" class="card-title mg-b-0 btn btn-warning" data-toggle="modal" data-target="#modaldemo1">اضافه نوع عقار</a>
@endcan
                                                        ...
                                                        <table class="table text-md-nowrap" id="example">
                                                            ...
                                                            <tbody>
                                                                <?php $i=0?>
                                                                    ...
                                                                    <td>
                                                                        @can('تعديل نوع عقار')
                                                                        <a   href="{{url('/edit_real_estate_name',$item->id)}}" class="btn btn-primary">تعديل</a>
                                                                        @endcan
                                                                        @can('حذف نوع عقار')
                                                                        <a href="{{ url('delete_real_estate_name', ['id' => $item->id]) }}" class="btn btn-danger delete-button">حذف</a>
                                                                        @endcan
                                                                    </td>
                                                                    </tr>
                                                                    @endforeach
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content modal-content-demo">
					<div class="modal-header">
						<h6 class="modal-title">اضافه نوع عقار</h6><button aria-label="Close" class="close" data-dismiss="modal" type="button"><span aria-hidden="true">&times;</span></button>
					</div>
					<div class="modal-body">
                    <form action="{{url('/add_real_estate')}}" method="post">
                    @csrf
                    <input class="form-control m-1" type="text" name="real_estate_name" placeholder="نوع العقار">
